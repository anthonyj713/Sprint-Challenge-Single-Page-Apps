...
> Answer: The benefits of client side routing is less data is processed making routing between views generally faster. Also there are smoother transistions and animations between views.
